"""Advanced backtesting script to test Multi-Window Ensemble and Fractional Cooldowns for 10-minute options.
Goal: Maximize both win rate and trade count simultaneously.
"""
...
def main():
    ...
    cooldown_settings = [2, 3, 5, 10]  # Cooldown minutes
    ...
    # Sort by PnL to find the most profitable configuration
    ...
    for i, r in enumerate(results[:15]):
        ...
        print(f"#{i+1:<3d} | {r['type']:22s} | {r['cooldown']:3d}m | {pct_str:6s} | {thres_str:8s} | {r['trades']:6d} | {tr_per_day:6.2f} | {r['wr']:8.2f}% | ${r['pnl']:+8.2f} | {r['streak']:15d}")
