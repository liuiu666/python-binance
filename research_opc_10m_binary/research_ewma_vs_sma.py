"""Comparing Simple Moving Average (SMA) and Exponentially Weighted Moving Average (EWMA) parameter estimation under normal scaling.
"""
...
def run_backtest(df, lookback, tail_pct, horizon, estimation_method="sma"):
    ...
    z_scores = np.sqrt(horizon) * (rolling_mean / rolling_std)
