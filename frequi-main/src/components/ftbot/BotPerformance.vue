...
>(() => {
  ...
  return [
    ...
    {
      key: 'profit_abs',
      label: `盈亏 ${botStore.activeBot.botState?.stake_currency}`,
...
const options = [
  { value: PerformanceOptions.performance, text: '性能' },
  { value: PerformanceOptions.entryStats, text: '入场' },
  { value: PerformanceOptions.exitStats, text: '退出' },
...
<template>
  <div>
    <div class="mb-2">
      <h3 class="me-auto text-2xl inline">性能统计</h3>
