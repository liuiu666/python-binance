  ...
  return [
    {
      slot: 'pairs',
      value: 'pairs',
      label: showText ? '交易对组合' : undefined,
      icon: 'i-mdi-view-list',
    },
    {
      slot: 'general',
      value: 'general',
      label: showText ? '概况' : undefined,
      icon: 'i-mdi-information',
    },
    {
      slot: 'performance',
      value: 'performance',
      label: showText ? '性能' : undefined,
      icon: 'i-mdi-chart-line',
    },
    {
      slot: 'balance',
      value: 'balance',
      label: showText ? '余额' : undefined,
      icon: 'i-mdi-bank',
    },
    {
      slot: 'time-breakdown',
      value: 'time-breakdown',
      label: showText ? '时间分布' : undefined,
      icon: 'i-mdi-folder-clock',
    },
    {
      slot: 'pairlist',
      value: 'pairlist',
      label: showText ? '交易对列表' : undefined,
      icon: 'i-mdi-format-list-group',
    },
    {
      slot: 'pair-locks',
      value: 'pair-locks',
      label: showText ? '交易对锁定' : undefined,
  ...
  >
    <template #default="{ gridItemProps }">
      ...
      <GridItem
        ...
        drag-allow-from=".drag-header"
      >
        <DraggableContainer header="当前交易">
          <TradeList
            class="open-trades"
            :trades="botStore.activeBot.openTrades"
            title="当前交易"
      ...
      <GridItem
        ...
        drag-allow-from=".drag-header"
      >
        <DraggableContainer header="历史交易">
          <TradeList
            class="trade-history"
