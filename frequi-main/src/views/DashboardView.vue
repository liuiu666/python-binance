...
<template>
  ...
  >
    <template #default="{ gridItemProps }">
      ...
      >
        <DraggableContainer :header="`盈丏走势 ${botStore.botCount > 1 ? '(汇总)' : ''}`">
      ...
      >
        <DraggableContainer
          header="当前持仓"
          info-text="所有已选机器人的持仓信息。点击交易可跳转到该交易/机器人的交易页面。"
        >
      ...
      <GridItem
        ...
        drag-allow-from=".drag-header"
      >
        <DraggableContainer header="累计盈丏">
          <CumProfitChart
      ...
      <GridItem
        ...
        drag-allow-from=".drag-header"
      >
        <DraggableContainer header="账户历史">
      ...
      >
        <DraggableContainer
          header="历史交易"
          info-text="所有已选机器人的历史交易。点击交易可跳转到该交易/机器人的交易页面。"
        >
          <TradeList
            :active-trades="false"
            show-filter
      ...
      <GridItem
        ...
        drag-allow-from=".drag-header"
      >
        <DraggableContainer header="盈丏分布">
      ...
      <GridItem
        ...
        drag-allow-from=".drag-header"
      >
        <DraggableContainer header="交易日志图">
