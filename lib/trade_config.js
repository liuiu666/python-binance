const BACKTEST_PRESETS = {
  ...
  SECOND_CHIP: {
    CHIP: { wr: 100.0, tradesPerDay: 11.78, trades: 10, maxLoss: 0, sampleHours: 20.37 }
  }
};
...
const DEFAULT_STRATEGY_VARIANTS = [
  ...
  { id: "BTC_10min_SECOND_CHIP_3600_20", base: "SECOND_CHIP", label: "秒级筹码区 60m 20% 0.23%", amount: "5", enabled: true, tradeEnabled: false, lookbackSec: 3600, horizonSec: 600, gapSec: 600, chipTargetShare: 0.2, chipBinMode: "fixed", chipBinSize: 20, chipBinPct: 0.0003, chipBreakPct: 0.0023, chipDirectionFilter: "breakout_up_only" }
];
...
function backtestForVariant(base, tailPct) {
  if (base === "SECOND_CHIP") return BACKTEST_PRESETS.SECOND_CHIP.CHIP;
